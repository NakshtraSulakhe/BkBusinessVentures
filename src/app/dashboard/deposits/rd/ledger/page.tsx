...
export default function RDLedgerPage() {
  ...
  const fetchTransactions = async () => {
    try {
      setLoading(true)
      // Filter transactions that belong to RD accounts
  ...
  return (
    <DashboardLayout>
      <div className="p-6 min-h-screen bg-gradient-to-br from-slate-50 to-green-50/20">
        <div className="max-w-7xl mx-auto space-y-6">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              <Button
                ...
                className="h-10 w-10 p-0 rounded-full hover:bg-green-50 transition-colors"
              >
              ...
              <div>
                ...
                <p className="text-gray-600 mt-2 flex items-center">
                  <BookOpenIcon className="h-4 w-4 mr-2 text-green-500" />
                  Consolidated transaction history for all Recurring Deposits
                </p>
              </div>
            </div>
            <div className="flex items-center space-x-3">
              <Button variant="outline" className="h-12 border-green-200 text-green-700 hover:bg-green-50">
          ...
          {/* Filters */}
          <Card className="bg-white/60 backdrop-blur-sm shadow-sm border-green-50">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      className="pl-10 h-10 shadow-sm transition-all focus:ring-green-500"
                    />
                  </div>
                </div>
          ...
          {/* Ledger Table */}
          <Card className="bg-white/60 backdrop-blur-sm shadow-lg border-green-100">
                ...
                <Table>
                  ...
                  <TableBody>
                    {filteredTransactions.map((tx) => (
                      <TableRow key={tx.id} className="hover:bg-green-50/20 transition-colors border-b border-gray-100">
                        ...
                        <TableCell className="font-mono text-sm font-medium text-green-700">
                        ...
                        <TableCell className="text-right">
                          <span className={`font-bold ${
                            ['INSTALLMENT', 'deposit', 'INTEREST'].some(t => tx.type.toUpperCase().includes(t)) 
                              ? 'text-green-600' 
                              : 'text-red-600'
                          }`}>
                ...
                <div className="text-center py-16">
                  ...
                  <p className="text-gray-500 mt-2 max-w-sm mx-auto">
                    {searchTerm || typeFilter !== 'all' 
                      ...
                      : 'This ledger will populate as transactions are posted to RD accounts.'}
                  </p>
                </div>
              )}
            </CardContent>
