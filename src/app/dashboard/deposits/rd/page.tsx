        ...
        <div className="max-w-7xl mx-auto space-y-6">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-600 mt-2 flex items-center">
                  ...
                  Manage all recurring deposit accounts
                </p>
              </div>
            </div>
            <div className="flex items-center space-x-3">
              ...
              <Button
                onClick={() => router.push('/dashboard/deposits/rd/create')}
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <Card className="bg-white/60 backdrop-blur-sm">
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm font-medium text-gray-600">Total RD Accounts</p>
            ...
            <Card className="bg-white/60 backdrop-blur-sm">
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm font-medium text-gray-600">Active RDs</p>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-3xl font-bold text-blue-600">
                      ₹{filteredAccounts.reduce((sum, acc) => sum + (acc.principalAmount / acc.tenure), 0).toLocaleString()}
                    </p>
                  </div>
          ...
          <Card className="bg-white/60 backdrop-blur-sm">
            <CardHeader>
              <CardTitle className="text-xl font-semibold">RD Accounts</CardTitle>
            </CardHeader>
            <CardContent>
              {loading ? (
                <div className="text-center py-8">
                  <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-blue-600 mx-auto"></div>
                  <p className="mt-2 text-gray-600">Loading RD accounts...</p>
                </div>
              ) : filteredAccounts.length > 0 ? (
                <Table>
                  <TableHeader>
                  ...
                  <TableBody>
                    {filteredAccounts.map((account) => (
                      <TableRow key={account.id} className="hover:bg-gray-50/50">
                        ...
                        <TableCell>₹{(account.principalAmount / account.tenure).toLocaleString()}</TableCell>
                        ...
                        <TableCell>
                          <div className="flex items-center space-x-2">
                            <Button
                              variant="outline"
                              size="sm"
                              onClick={() => router.push(`/dashboard/deposits/rd/${account.id}`)}
                            >
                            ...
                            <Button
                              variant="outline"
                              size="sm"
                              onClick={() => router.push(`/dashboard/deposits/rd/${account.id}/edit`)}
                            >
                ...
                <div className="text-center py-8">
                  ...
                  <h3 className="mt-2 text-sm font-medium text-gray-900">No RD accounts found</h3>
                  <p className="mt-1 text-sm text-gray-500">
                    {searchTerm ? 'Try adjusting your search terms' : 'Get started by creating your first RD account'}
                  </p>
                  <div className="mt-6">
                    <Button
                      onClick={() => router.push('/dashboard/deposits/rd/create')}
